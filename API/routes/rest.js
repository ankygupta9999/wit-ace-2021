...
router.post('/supplier', restController.createSupplier);
router.post('/material', restController.createMaterial);
router.post('/buyer', restController.createBuyer);
// REST service - fetch shopping list by ID
router.get('/lists/discovery/:listId', restController.read);
...
router.get('/watson', restController.watsonSearch);
