...
function createSupplier(request) {
    return listsDaoImpl.createSupplier(request);
}

function createBuyer(request) {
    return listsDaoImpl.createBuyer(request);
}

function createMaterial(request) {
    return listsDaoImpl.createMaterial(request);
}
